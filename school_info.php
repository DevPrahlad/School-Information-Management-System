...
<form id="searchForm">
  ...
  <select id="region" name="region" onchange="loadSchools()">
...
<script>
  function loadSchools() {
    ...
    $.ajax({
      url: "get_faculty_data", // Create a separate PHP file to handle this request
      type: "POST",
      data: { region: region },
  ...
  function searchData() {
    ...
    $.ajax({
      url: "search_data", // Create a separate PHP file to handle this request
      type: "POST",
      data: { region: region, school: school },
      success: function(data) {
        $("#result").html(data);
      }
    });
