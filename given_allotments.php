  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Given Allotments</span>
      </div>
...
if ($result->num_rows > 0) {
    echo '<div class="card">';
    echo '<table>';
    echo '<tr><th>Sr.No.</th><th>Date</th><th>Region</th><th>School Name</th><th>Start Date</th><th>End Date</th><th>Status</th><th>Action</th></tr>';
    $cnt = 1;
    ...
    echo "<p>Currently There Is No Allotment.</p>";
}
