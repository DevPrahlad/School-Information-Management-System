...
if (isset($_POST['downloadCSV'])) {
   ...
   // $conn = new mysqli("sql300.infinityfree.com", "if0_35461702", "GDQeZzlMVTQ", "if0_35461702_erps");
    $con = new mysqli("localhost", "ourwebpr_dk", "1u0lATw[*8dx", "ourwebpr_deeksha");
...
.dropdown:hover .dropdown-menu {
    ...
    label {
        flex-basis: 48%; /* Takes almost half of the container width */
        margin-bottom: 8px;
    }
